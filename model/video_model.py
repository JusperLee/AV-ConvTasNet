'''
Author: Kai Li
Date: 2021-03-11 22:29:16
LastEditors: Kai Li
LastEditTime: 2021-03-12 14:59:18
'''
...
class front3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, class_dim=256):
        super(front3D, self).__init__()
        self.conv3d = nn.Sequential(
            nn.Conv3d(in_channels, out_channels, kernel_size=(5, 7, 7), stride=(
...
class video(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=64, video_channels=256,
                 resnet_dim=256, kernel_size=3, repeat=5):
        super(video, self).__init__()
        self.front3d = front3D(in_channels, out_channels, class_dim=256)
